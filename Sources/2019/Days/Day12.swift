...
struct Day12: Day {
    ...
    struct LunarSystem: RawRepresentable {
        ...
        var totalEnergy: Int {
            io.totalEnergy + europa.totalEnergy + ganymede.totalEnergy + callisto.totalEnergy
        }
        ...
        mutating func findMinimumCycles() -> Int {
            ...
            simulate(continueHandler: { sys in
                ...
                if steps[0] == nil {
                    if sys.io.position.x == ioInitial.position.x && sys.io.velocity.x == ioInitial.velocity.x
                ...
                if steps[1] == nil {
                    if sys.io.position.y == ioInitial.position.y && sys.io.velocity.y == ioInitial.velocity.y
                ...
                if steps[2] == nil {
                    if sys.io.position.z == ioInitial.position.z && sys.io.velocity.z == ioInitial.velocity.z
