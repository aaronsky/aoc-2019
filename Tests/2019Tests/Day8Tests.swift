...
class Day8Tests: XCTestCase {
    func testProblems() async throws {
        ...
        XCTAssertEqual(problem, "100100110001100111101111010010100101001010000100001111010000100001110011100100101000010110100001000010010100101001010000100001001001100011101000011110")
    ...
    func testSimpleProgram1() {
        ...
        let layers = Array<Day8.Layer>(rawImage: Day8.RawImage(pixels: pixels,
                                                          width: 2,
                                                          height: 2))
